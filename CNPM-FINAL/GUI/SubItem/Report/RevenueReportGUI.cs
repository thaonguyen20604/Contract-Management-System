...
{
    public partial class RevenueReportGUI : Form
    {
        ...
        private void InitTextContent()
        {
            ...
            resourceManager = new ResourceManager(ResourceContext.REVENUE_REPORT_GUI, typeof(RevenueReportGUI).Assembly);
            ...
            this.columnDate.HeaderText = GetLocalizedString("columnPaymentDate");
            this.columnOrganization.HeaderText = GetLocalizedString("columnOrganization");
            this.columnStage.HeaderText = GetLocalizedString("columnStageName");
        ...
        private void RenderList(string keyword = "")
        {
            try
            {
                ...
                foreach (var payment in payments)
                {
                    ...
                    dataGridView.Rows.Add(payment.contractCode, payment.contractName, payment.organizationName,
                        payment.stageName, payment.paymentDate.ToString("dd/MM/yyyy"),
